...
public class DownloadAsyncController {
    ...
    public Response getDownloadStatus(
        ...
        if (status == DownloadTask.Status.PENDING || status == DownloadTask.Status.IN_PROGRESS) {
            ...
            for (int i = 1; i <= chunkCount; i++) {
                ...
                sb.append("<li><a href=\"").append(chunkLink).append("\">").append(name).append(".").append(i).append(".txt")
                        .append("</a>");
                if (chunk != null) {
                    sb.append(" CRC32: ").append(chunk.getCrc32Hex()).append(" | MD5: ").append(chunk.getMd5Hex());
                }
                sb.append("</li>");
            }
            sb.append("</ol>");
    ...
    public Response getDownloadChunk(
        ...
        return Response.ok(downloadChunk.getBase64Content())
